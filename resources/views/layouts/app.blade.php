...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="../../index2.html" class="logo">
            ...
            <span class="logo-mini"><B>A</B>Bank</span>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                ...
                                <div class="pull-right">
                                    {!! Form::open(['method'=>'post' , 'url'=>url('logout')]) !!}
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <li><a href="{{url(route('contact.index'))}}"><i class="fa fa-list"></i> <span>Contacts</span></a></li>
                <li><a href="{{url(route('setting.index'))}}"><i class="fa fa-book"></i> <span>Settings</span></a></li>
                <li><a href="{{url(route('post.index'))}}"><i class="fa fa-book"></i> <span>Posts</span></a></li>
                <li><a href="{{url(route('client.index'))}}"><i class="fa fa-users"></i> <span>clients</span></a></li>
                ...
                <li><a href="{{url(route('donation-request.index'))}}"><i class="fa fa-list"></i> <span>donations</span></a></li>
                <li><a href="{{url('reset-password')}}"><i class="fa fa-list"></i> <span>reset-password</span></a></li>
