                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                @if($record->is_active==1)
                                    <a href="{{url('is-active/'.$record->id)}}">disactive</a>
                                    @else
                                    <a href="{{url('is-active/'.$record->id)}}">active</a>

                                @endif
                            </td>
                            <td class="text-center"><a href="{{url(route('user.edit',$record->id))}}" class="btn btn-primary xs"><i class="fa fa-edit"></i></a></td>
                            <td class="text-center">
                                {!!Form::open([
